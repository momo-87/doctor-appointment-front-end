    ...
    <div>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="text-center">
          <button
            className="hover:bg-white hover:text-color-green border-[2px] border-color-gray width-[100px] bg-color-green mt-[0px] px-[30px] py-[15x] rounded-2xl text-white transition-colors duration-300 ease-in-out"
            type="button"
